...
\begin{abstract}
Este estudio presenta un análisis espectral y temporal de los destellos de rayos gamma bn090926181 y bn090424592, utilizando datos de los detectores NaI y BGO del Fermi GBM.  Se generan curvas de luz en los rangos 8-50 keV, 50-300 keV y 300-900 keV y se realiza un ajuste del pico de emisión con el modelo de Band, complementado por componentes de cuerpo negro, modelo comptonizado y ley de potencias.  
Se incluye un análisis resuelto en el tiempo que muestra la evolución de los parámetros espectrales y su correlación con la curva de luz del evento.  
Los resultados indican que la energía pico y el índice $\alpha$ siguen la forma de la curva de luz, mientras que $\beta$ presenta mayor incertidumbre en intervalos muy cortos; la combinación multicomponente mejora la descripción del espectro observado. 
\end{abstract}
...
\begin{figure}
    \centering
    \includegraphics[width=0.8\linewidth]{imagenes/lc_n3.png}
    \caption{Curvas de luz del detector n3 para bn090424592 a tres rangos de energía.}
    \label{fig:lc_n3}
\end{figure}
