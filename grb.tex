...
Durante la realización de este proyecto, se analizaron dos destellos de rayos
gamma, caracterizados por los nombres bn090926181 y bn090424592. Puesto que el
...
La Figura \ref{fig:181-band} muestra los conteos por segundo
(gris) y los ajustes para los parámetros de Energía pico (azul), $\alpha$
(verde) y $\beta$ (rojo) del objeto bn090926181. Las cuatro gráficas comparten
el mismo eje horizontal, que representa el tiempo en segundos.
