...
intervalo_tiempo = 1
limite_maximo_beta = -0.2
grado_fit_polinomial = 1
...
class GRBSpectralAnalysis:
    ...
    def fit_background(self):
        ...
        self.backfitters.fit(order=grado_fit_polinomial)
    ...
    def fit_spectrum(self):
        ...
        self.band.max_values[3] = limite_maximo_beta
    ...
    def fit_multiple_time_ranges(self, start_time=1, end_time=20, duration=intervalo_tiempo):
        ...
        for i in range(start_time, end_time + 1, duration):
            ...
            try:
                ...
                band.max_values[3] = limite_maximo_beta
    ...
    def run_time_evolution_analysis(self, start_time=1, end_time=20, duration=intervalo_tiempo):
...
def main():
    ...
    results = grb_analysis.run_time_evolution_analysis(start_time=1, end_time=20, duration=intervalo_tiempo)
